...
values('What is your favourite food?');
insert into UserSecurityQuestions (UserSecurityQuestion)
values('What is your favourite food?');
insert into UserSecurityQuestions (UserSecurityQuestion)
values('What is your favourite food?');
...
Insert into AccountType (AccountTypeDescription)
values('Checking');
insert into SavingsInterestRates (InterestRatesValue, InterestRatesDescription)
values(0.5, 'Low');
insert into SavingsInterestRates (InterestRatesValue, InterestRatesDescription)
values(2, 'Medium');
insert into SavingsInterestRates (InterestRatesValue, InterestRatesDescription)
...
insert into SavingsInterestRates (InterestRatesValue, InterestRatesDescription)
values(5, 'Super high');
insert into AccountStatusType (AccountStatusTypeDescription)
values('Closed');
insert into AccountStatusType (AccountStatusTypeDescription)
values('Active');
insert into AccountStatusType (AccountStatusTypeDescription)
...
insert into AccountStatusType (AccountStatusTypeDescription)
values('Active');
insert into FailedTransactionErrorType (FailedTransactionErrorTypeDescription)
values('Withdraw limit reached');
insert into FailedTransactionErrorType (FailedTransactionErrorTypeDescription)
values('Daily limit reached');
insert into FailedTransactionErrorType (FailedTransactionErrorTypeDescription)
values('No tenough balance');
insert into FailedTransactionErrorType (FailedTransactionErrorTypeDescription)
values('Invalid denomination');
insert into FailedTransactionErrorType (FailedTransactionErrorTypeDescription)
values('ATM machine down');
insert into LoginErrorLog (ErrorTime, FailedTransactionXML)
values('2015/6/4 07:30:56', 'Bad Connection');
insert into LoginErrorLog (ErrorTime, FailedTransactionXML)
values('2018/6/9 12:34:57', 'Invalid User');
insert into LoginErrorLog (ErrorTime, FailedTransactionXML)
values('2016/4/5 02:14:00', 'Wrong Password');
insert into LoginErrorLog (ErrorTime, FailedTransactionXML)
values('2014/7/5 05:56:59', 'Server issue');
insert into LoginErrorLog (ErrorTime, FailedTransactionXML)
values('2009/10/12 08:34:15', 'Datacenter down');
...
values('Transfer', 'Send money', '450');
insert into TransactionType (
		TransactionTypeName,
		TransactionTypeDescription,
		TransactionFeeAmount
	)
values('Receive', 'Get money', '300');
insert into TransactionType (
		TransactionTypeName,
		TransactionTypeDescription,
		TransactionFeeAmount
	)
values('Paid', 'Paid to John', '45000');
insert into TransactionType (
		TransactionTypeName,
		TransactionTypeDescription,
		TransactionFeeAmount
	)
values('Statement', 'Checked monthly transaction', '0');
insert into FailedTransactionLog (
		FailedTransactionErrorTypeID,
		FailedTransactionErrorTime,
		FailedTransactionErrorXML
	)
values(1, '2015/6/4 07:30:56', 'First');
insert into FailedTransactionLog (
		FailedTransactionErrorTypeID,
		FailedTransactionErrorTime,
		FailedTransactionErrorXML
	)
values(2, '2018/6/9 12:34:57', 'Second');
insert into FailedTransactionLog (
		FailedTransactionErrorTypeID,
		FailedTransactionErrorTime,
		FailedTransactionErrorXML
	)
values(3, '2016/4/5 02:14:00', 'Third');
insert into FailedTransactionLog (
		FailedTransactionErrorTypeID,
		FailedTransactionErrorTime,
		FailedTransactionErrorXML
	)
values(4, '2014/7/5 05:56:59', 'Fourth');
insert into FailedTransactionLog (
		FailedTransactionErrorTypeID,
		FailedTransactionErrorTime,
		FailedTransactionErrorXML
	)
values(5, '2009/10/12 08:34:15', 'Fifth');
insert into UserSecurityAnswers (UserSecurityAnswers, UserSecurityQuestionID)
values('Apples', 1);
insert into UserSecurityAnswers (UserSecurityAnswers, UserSecurityQuestionID)
values('Spiderman', 2);
insert into UserSecurityAnswers (UserSecurityAnswers, UserSecurityQuestionID)
...
insert into Account (
		...
		AccountTypeID,
		AccountStatusTypeID,
		InterestSavingRatesID
	)
values(15000.7, 1, 1, 1);
insert into Account (
		CurrentBalance,
		AccountTypeID,
		AccountStatusTypeID,
...
values('2015/6/4 07:30:56', 0, 'Clear');
insert into OverDraftLog (
		OverDraftDate,
		OverDraftAmount,
		OverDraftTransactionXML
	)
values('2018/6/9 12:34:57', 5, 'Pending');
insert into OverDraftLog (
		OverDraftDate,
		OverDraftAmount,
		OverDraftTransactionXML
	)
values('2016/4/5 02:14:00', 10, 'Clear');
insert into OverDraftLog (
		OverDraftDate,
		OverDraftAmount,
		OverDraftTransactionXML
	)
values('2014/7/5 05:56:59', 15, 'Pending');
insert into OverDraftLog (
		OverDraftDate,
		OverDraftAmount,
		OverDraftTransactionXML
	)
values('2009/10/12 08:34:15', 20, 'Clear');